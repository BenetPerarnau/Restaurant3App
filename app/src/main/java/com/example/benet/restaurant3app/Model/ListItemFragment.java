...
import com.example.benet.restaurant3app.Test.MainActivity;
 ...
 */
public final class ListItemFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        list.setAdapter(new ItemAdapter(getActivity(),data,R.layout.item_list));
    ...
    public void onButtonPressed(int position) {
        if (mListener != null) {
            mListener.onFragmentInteractionListItem(position);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        if(arg!=null){data=(ArrayList<Restaurant>)arg.getSerializable(MainActivity.SEND_DATA);}
    }
